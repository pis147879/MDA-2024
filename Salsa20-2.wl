...
BitRotateLeft[x_, offset_] :=  
    BitAnd[
        BitXor[BitShiftRight[x, wordsize - offset],BitShiftLeft[x, offset]], 
        modulo - 1
    ];
...
QuarterRound[y_] := Module[{z1, z2, z3, z0, y0, y1, y2, y3},
  (
   {y0, y1, y2, y3} = y; 
   z1 = BitAnd[BitXor[y1, BitRotateLeft[Mod[y0 + y3, modulo], 7]], modulo - 1];
   z2 = BitAnd[BitXor[y2, BitRotateLeft[Mod[y0 + z1, modulo], 9]], modulo - 1];
   z3 = BitAnd[BitXor[y3, BitRotateLeft[Mod[z2 + z1, modulo], 13]], modulo - 1];
   z0 = BitAnd[BitXor[y0, BitRotateLeft[Mod[z3 + z2, modulo], 18]], modulo - 1];
   {z0, z1, z2, z3}
   )];
